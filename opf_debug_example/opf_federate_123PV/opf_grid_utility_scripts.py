...
def unpack_fdrvals_vecs(opfobj):
    ...
    opfobj.pL = np.array(opfobj.powers_P.array)
    opfobj.qL = np.array(opfobj.powers_Q.array)
    opfobj.p_flex_load_init = opfobj.flex_load_inc_matrix.T.dot(opfobj.pL)
    opfobj.cap_bank_init = opfobj.cap_load_inc_matrix.T.dot(np.array(opfobj.cap_Q.array))
    opfobj.pv_p_init = opfobj.pv_inc_matrix.T.dot(np.array(opfobj.pv_P.array))
    opfobj.pv_q_init = opfobj.pv_inc_matrix.T.dot(np.array(opfobj.pv_Q.array))
