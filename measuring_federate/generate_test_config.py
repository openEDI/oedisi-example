...
if __name__ == "__main__":
    seed(12345)
    print(MeasurementConfig(
        name = "MeasurementFederate",
        gaussian_variance = 0.1,
        voltage_ids = sample(BUSES, len(BUSES) // 2),
        real_power_ids = sample(BUSES, len(BUSES) // 2),
        reactive_power_ids = sample(BUSES, len(BUSES) // 2)
    ).json(indent=2))
